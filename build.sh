...
files="__init__.py account.py event.py exceptions.py room.py __main__.py auth.py helpers.py person.py schedule.py camera.py home.py public_data.py thermostat.py __version__.py const.py home_coach.py py.typed weather_station.py"
